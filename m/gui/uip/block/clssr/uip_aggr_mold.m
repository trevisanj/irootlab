...
%> @cond
function varargout = uip_aggr_mold(varargin)
% Last Modified by GUIDE v2.5 16-Jan-2012 22:21:15

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @uip_aggr_mold_OpeningFcn, ...
                   'gui_OutputFcn',  @uip_aggr_mold_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before uip_aggr_mold is made visible.
function uip_aggr_mold_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = uip_aggr_mold_OutputFcn(hObject, eventdata, handles) 
try

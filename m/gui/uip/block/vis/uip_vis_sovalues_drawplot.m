...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @uip_vis_sovalues_drawplot_OpeningFcn, ...
                   'gui_OutputFcn',  @uip_vis_sovalues_drawplot_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before uip_vis_sovalues_drawplot is made visible.
function uip_vis_sovalues_drawplot_OpeningFcn(hObject, eventdata, handles, varargin) %#ok<*INUSL>
if nargin > 4
...
function varargout = uip_vis_sovalues_drawplot_OutputFcn(hObject, eventdata, handles) 
try

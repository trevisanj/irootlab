...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @uip_blmisc_split_ovr_OpeningFcn, ...
                   'gui_OutputFcn',  @uip_blmisc_split_ovr_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
%#####
function uip_blmisc_split_ovr_OpeningFcn(hObject, eventdata, handles, varargin)
if nargin > 4
...
%#####
function varargout = uip_blmisc_split_ovr_OutputFcn(hObject, eventdata, handles) 
try
